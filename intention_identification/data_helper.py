...
from intention_identification.utils import create_file_dir, read_file
...
class MyDataset(Dataset):
    ...
    def __init__(self, data_files, token_vocab, label_vocab, pad_token='<PAD>',
        ...
        if isinstance(label_vocab, str):
            self.label_vocab = torch.load(token_vocab, map_location='cpu')
        else:
            self.label_vocab = token_vocab
