...
class NEZHAConfig(PretrainedConfig):
    ...
    def __init__(self,
        ...
        """
        super(NEZHAConfig, self).__init__()
    ...
    @classmethod
    def from_dict(cls, json_object: Dict[str, Any], **kwargs) -> "NEZHAConfig":
    ...
    @classmethod
    def from_json_file(cls, json_file) -> "NEZHAConfig":
...
class NEZHAModel(BertPreTrainedModel):
    ...
    def forward(self, input_ids, token_type_ids=None, attention_mask=None, output_attention_mask=False,
                model_distillation=False, output_hidden_states=False):
